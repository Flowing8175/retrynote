...
const FEATURES: FeatureRow[] = [
  ...
  { label: '크레딧 (30일)', free: '100 크레딧', lite: '1,200 크레딧', standard: '4,000 크레딧', pro: '14,000 크레딧' },
  { label: 'OCR 페이지 (30일)', free: '100페이지', lite: '2,000페이지', standard: '10,000페이지', pro: '40,000페이지' },
